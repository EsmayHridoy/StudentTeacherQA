<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StudentProfile.aspx.cs" Inherits="StudentTeacherQA.StudentProfile" %>
        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <%-- Credintials --%>
                    <center>
                        <span class="badge badge-pill badge-primary">Your Credintial</span>
                    </center>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <asp:TextBox class="form-control" ID="TextBox6" runat="server" 
                                    placeholder="Enter Your Password" TextMode="Password" ReadOnly="true">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <center>
                                <img width="100px" src="imgs/QA%20icon.png" />
                            </center>
                        </div>
                    </div>
